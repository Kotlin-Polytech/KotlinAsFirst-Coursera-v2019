...
class Tests {
    ...
    fun daysInMonth() {
        ...
        assertEquals(30, daysInMonth(9, 2000))
        assertEquals(31, daysInMonth(10, 2000))
        assertEquals(30, daysInMonth(11, 2000))
        assertEquals(31, daysInMonth(12, 2000))
        assertEquals(-1, daysInMonth(13, 2000))
    }
