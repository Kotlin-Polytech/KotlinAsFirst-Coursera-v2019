...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val yearCoefficient: Double = 1.0 + percent / 100.0
    val firstYearSum: Double = initial * yearCoefficient
    val secondYearSum: Double = firstYearSum * yearCoefficient
    return secondYearSum * yearCoefficient // result we're searching for
}
